...
These simple examples explore how to organize the code in order to facilitate its development, modularity and of course maintainability. The idea is to comply with aa so-called MVC architecture.
